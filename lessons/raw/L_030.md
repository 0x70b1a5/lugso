...
<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='sʌʒʃ nʌ'>🔈</button>  </span> <strong>so35 no</strong>
...
<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='sʌʒʃ ðʌʔiɻ θɮu'>🔈</button>  </span> <strong>so35 do'ir tlu</strong>
