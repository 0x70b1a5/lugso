...
<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='fuθnu vʌsə fuʒəɻ βʌθuθɮiʃix'>🔈</button>  </span> <strong>futnu voso fu3or botutli5ix</strong>

`father-VOC 1PL.EX-GEN be_location-REL distant-SUPER-LOC`,

_Our Father, Who art in heaven,_

<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='ɻɣiz zufuxɮjə zujn-ɸus ðʌsə'>🔈</button>  </span> <strong>rgiz zufuxlyo zuyn-pus doso</strong>

`FORM fear-PTCP.PASS name 2SG-GEN`.

_Hallowed be Thy name,_

<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='zfʌjɣiɻɣiz zjuɣiʃ ðʌsə'>🔈</button>  </span> <strong>zfoygirgiz zyugi5 doso</strong>

`come-IMP-FORM dominion-master 2SG-GEN`,

_Thy kingdom come,_

<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='sɻuʒiɣiɻɣiz fuʃix βʌθuθɮiʃixið ʌθ ðʌsə'>🔈</button>  </span> <strong>sru3igirgiz fu5ix botutli5ixid ot doso</strong>

`realize-IMP-FORM earth-LOC distant-SUPER-LOC-CONJ.N will 2SG-GEN`.

_Thy will be done, on earth as it is in heaven._

<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='juɻɣʔɣiɻɣiz xuxifʔfə iθɣixn iθɣixzxi vʌɮuɮ'>🔈</button>  </span> <strong>yurg'girgiz xuxif'fo itgixn itgixzxi volul</strong>

`give-IMP-FORM food-INS aeon-DIM-ADJ.DER aeon-DIM-TEMP 1PL.EX-BEN`,

_Give us this day our daily bread,_

<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='θjʌɣiɻɣizuβ sɸiɸsziðiɻ vʌsə vʌɮuɮ'>🔈</button>  </span> <strong>tyogirgizub spipszidir voso volul</strong>

`forget-IMP-FORM-CONJ.and balance-NEG-PL-ACC 1PL.EX-GEN 1PL.EX-BEN`

_and forgive us our trespasses_

<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='θjʌsəɸs sɸiɸsziʔiʔəɻ vʌʔiɻ vʌ ivəɮðɮuɮ'>🔈</button>  </span> <strong>tyosops spipszi'i'or vo'ir vo ivoldlul</strong>
...
<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='βɣʌxziɣiɻɣizuβ xʌɣɮəzʔzəniɻ vʌɮuɮ'>🔈</button>  </span> <strong>bgoxzigirgizub xogloz'zonir volul</strong>

`lead-NEG-IMP-FORM-CONJ.and seduce-NMLZ.DER.act-ACC 1PL.EX-BEN`

_and lead us not into temptation,_

<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='xzuxɣiɻɣiziʃ ɣuʒuɣ vʌɮuɮ'>🔈</button>  </span> <strong>xzuxgirgizi5 gu3ug volul</strong>

`move-IMP-FORM-CONJ.but chaos-ABL 1PL.EX-BEN`

_but deliver us from evil._

<span class='spoken btnOnly'> <button class='speak' type='button' data-ipa='sɻuʒiz'>🔈</button>  </span> <strong>sru3iz</strong>
